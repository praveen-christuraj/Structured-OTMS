...
def apply_custom_css():
    ...
    body {
        background: radial-gradient(1200px 600px at 10% 10%, rgba(102,126,234,0.08) 0%, transparent 60%),
                    radial-gradient(1200px 600px at 90% 30%, rgba(118,75,162,0.08) 0%, transparent 60%),
    ...
    ::-webkit-scrollbar-thumb { background: rgba(37,99,235,0.35); border-radius: 10px; }
